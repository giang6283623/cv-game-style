            ...
            >
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '10px' }}>
                  ...
                  />
                  <div>
                    <h3 style={{ margin: 0, color: '#ffd93d' }}>
                      {exp.position}
                    </h3>
                    <p style={{ 
                      margin: '5px 0 0 0', 
                ...
                <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }}>
                  ...
                  <span style={{
                    padding: '4px 12px',
                    background: exp.current ? '#6bcf7f' : '#533483',
                  ...
                  <div style={{ 
                    ...
                    {exp.techStack.map((tech, i) => (
                      <motion.span
                        ...
                        style={{
                          background: 'linear-gradient(135deg, #533483, #3a2460)',
                          padding: '8px 16px',
                          fontSize: '1rem'
                        }}
                      >
                ...
                <div style={{ marginTop: '30px' }}>
                  ...
                  {exp.features.miniApp && (
                    <div style={{ marginBottom: '20px' }}>
                      <h5 style={{ color: '#b8b8d1', marginBottom: '10px' }}>Mini App Features:</h5>
                  ...
                  {exp.features.dashboard && (
                    <div>
                      <h5 style={{ color: '#b8b8d1', marginBottom: '10px' }}>Dashboard Features:</h5>
                      <ul style={{ paddingLeft: '20px' }}>
